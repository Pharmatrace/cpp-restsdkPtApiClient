...
void Location::fromJson(web::json::value& val)
{
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("location_type")];
        if(!fieldValue.is_null())
        {
...
void Location::setUuid(utility::string_t value)
{
    m_Uuid = value;
    m_UuidIsSet = true;
}
...
void Location::setLocationType(utility::string_t value)
{
