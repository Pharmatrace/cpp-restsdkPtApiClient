...
void SystemInformation::fromJson(web::json::value& val)
{
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("header")];
        if(!fieldValue.is_null())
        {
...
void SystemInformation::setUuid(utility::string_t value)
{
    m_Uuid = value;
    m_UuidIsSet = true;
}
...
void SystemInformation::setLanguage(utility::string_t value)
{
    m_Language = value;
...
void SystemInformation::setHeader(utility::string_t value)
{
    m_Header = value;
    m_HeaderIsSet = true;
}
...
void SystemInformation::setMessage(utility::string_t value)
{
    m_Message = value;
    m_MessageIsSet = true;
}
