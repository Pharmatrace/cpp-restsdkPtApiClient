...
void InformationQueryResponse::fromJson(const web::json::value& val)
{
...
int64_t InformationQueryResponse::getTimestamp() const
{
    return m_Timestamp;
}

void InformationQueryResponse::setTimestamp(int64_t value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool InformationQueryResponse::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void InformationQueryResponse::unsetTimestamp()
{
    m_TimestampIsSet = false;
}

utility::string_t InformationQueryResponse::getTxUid() const
{
    return m_Tx_uid;
}

void InformationQueryResponse::setTxUid(const utility::string_t& value)
{
    m_Tx_uid = value;
    m_Tx_uidIsSet = true;
}

bool InformationQueryResponse::txUidIsSet() const
{
    return m_Tx_uidIsSet;
}

void InformationQueryResponse::unsetTx_uid()
{
    m_Tx_uidIsSet = false;
}

utility::string_t InformationQueryResponse::getTermsId() const
{
    return m_Terms_id;
}

void InformationQueryResponse::setTermsId(const utility::string_t& value)
{
    m_Terms_id = value;
    m_Terms_idIsSet = true;
}

bool InformationQueryResponse::termsIdIsSet() const
{
    return m_Terms_idIsSet;
}

void InformationQueryResponse::unsetTerms_id()
{
    m_Terms_idIsSet = false;
}

utility::string_t InformationQueryResponse::getTransactionChannel() const
{
    return m_Transaction_channel;
}

void InformationQueryResponse::setTransactionChannel(const utility::string_t& value)
{
    m_Transaction_channel = value;
    m_Transaction_channelIsSet = true;
}

bool InformationQueryResponse::transactionChannelIsSet() const
{
    return m_Transaction_channelIsSet;
}

void InformationQueryResponse::unsetTransaction_channel()
{
    m_Transaction_channelIsSet = false;
}
