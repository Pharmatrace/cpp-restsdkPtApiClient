...
void Container::fromJson(web::json::value& val)
{
    if(val.has_field(utility::conversions::to_string_t("container_id")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("container_id")];
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("epc_code")];
        if(!fieldValue.is_null())
        {
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("barcode")];
        if(!fieldValue.is_null())
        {
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("rf_id")];
        if(!fieldValue.is_null())
        {
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("current_location_id")];
        if(!fieldValue.is_null())
        {
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("owner_stakeholder_id")];
        if(!fieldValue.is_null())
        {
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("parent_container_id")];
        if(!fieldValue.is_null())
        {
...
void Container::setContainerId(utility::string_t value)
{
...
void Container::setEpcCode(utility::string_t value)
{
    m_Epc_code = value;
...
void Container::setLabel(utility::string_t value)
{
    m_Label = value;
    m_LabelIsSet = true;
}
...
void Container::setBarcode(utility::string_t value)
{
    m_Barcode = value;
    m_BarcodeIsSet = true;
}
...
void Container::setRfId(utility::string_t value)
{
    m_Rf_id = value;
    m_Rf_idIsSet = true;
}
...
void Container::setUnit(utility::string_t value)
{
    m_Unit = value;
    m_UnitIsSet = true;
}
...
void Container::setCurrentLocationId(utility::string_t value)
{
...
void Container::setOwnerStakeholderId(utility::string_t value)
{
...
void Container::setParentContainerId(utility::string_t value)
{
