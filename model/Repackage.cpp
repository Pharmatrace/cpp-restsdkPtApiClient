...
void Repackage::validate()
{
    // TODO: implement validation
}

web::json::value Repackage::toJson() const
{
...
void Repackage::fromJson(const web::json::value& val)
{
...
void Repackage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Repackage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t Repackage::getTimestamp() const
{
    return m_Timestamp;
}

void Repackage::setTimestamp(int64_t value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool Repackage::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void Repackage::unsetTimestamp()
{
    m_TimestampIsSet = false;
}

utility::string_t Repackage::getTxUid() const
{
    return m_Tx_uid;
}

void Repackage::setTxUid(const utility::string_t& value)
{
    m_Tx_uid = value;
    m_Tx_uidIsSet = true;
}

bool Repackage::txUidIsSet() const
{
    return m_Tx_uidIsSet;
}

void Repackage::unsetTx_uid()
{
    m_Tx_uidIsSet = false;
}

utility::string_t Repackage::getTermsId() const
{
    return m_Terms_id;
}

void Repackage::setTermsId(const utility::string_t& value)
{
    m_Terms_id = value;
    m_Terms_idIsSet = true;
}

bool Repackage::termsIdIsSet() const
{
    return m_Terms_idIsSet;
}

void Repackage::unsetTerms_id()
{
    m_Terms_idIsSet = false;
}

utility::string_t Repackage::getTransactionChannel() const
{
    return m_Transaction_channel;
}

void Repackage::setTransactionChannel(const utility::string_t& value)
{
    m_Transaction_channel = value;
    m_Transaction_channelIsSet = true;
}

bool Repackage::transactionChannelIsSet() const
{
    return m_Transaction_channelIsSet;
}

void Repackage::unsetTransaction_channel()
{
    m_Transaction_channelIsSet = false;
}
