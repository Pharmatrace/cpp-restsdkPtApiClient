...
void Containers::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        {
        for( auto& item : val[utility::conversions::to_string_t("listing")].as_array() )
        {
            if(item.is_null())
            {
...
void Containers::setListing(std::vector<std::shared_ptr<Container>> value)
{
    m_Listing = value;
    m_ListingIsSet = true;
}
