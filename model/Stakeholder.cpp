...
void Stakeholder::fromJson(web::json::value& val)
{
    if(val.has_field(utility::conversions::to_string_t("trade_id")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("trade_id")];
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("trade_id_type")];
        if(!fieldValue.is_null())
        {
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("display_name")];
        if(!fieldValue.is_null())
        {
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("stakeholder_role")];
        if(!fieldValue.is_null())
        {
...
void Stakeholder::setTradeId(utility::string_t value)
{
    m_Trade_id = value;
...
void Stakeholder::setTradeIdType(utility::string_t value)
{
...
void Stakeholder::setDisplayName(utility::string_t value)
{
...
void Stakeholder::setStakeholderRole(utility::string_t value)
{
...
void Stakeholder::setWalletId(utility::string_t value)
{
    m_Wallet_id = value;
