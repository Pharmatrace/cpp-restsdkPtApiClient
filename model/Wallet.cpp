...
void Wallet::setWalletId(utility::string_t value)
{
    m_Wallet_id = value;
...
void Wallet::setDisplayName(utility::string_t value)
{
...
void Wallet::setOwnerStakeholderId(utility::string_t value)
{
