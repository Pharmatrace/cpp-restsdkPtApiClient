...
public:
    ...
    void setPharmaceuticalId(const utility::string_t& value);
    ...
    void setTradeName(const utility::string_t& value);
    ...
    void setEanCode(const utility::string_t& value);
    ...
    void setManufacturerId(const utility::string_t& value);
