...
public:
    ...
    void setTermsVersion(const utility::string_t& value);
    ...
    void setTermsIdPreviousVersion(const utility::string_t& value);
    ...
    void setTermsText(const utility::string_t& value);
    ...
    void setLegislation(const utility::string_t& value);
