...
public:
    ...
    void setContainerId(utility::string_t value);
    /// <summary>
    /// EPC code
    /// </summary>
    ...
    void unsetEpc_code();
    void setEpcCode(utility::string_t value);
    /// <summary>
    /// Serialization label.
    /// </summary>
    ...
    void unsetBarcode();
    void setBarcode(utility::string_t value);
    /// <summary>
    ...
    void unsetRf_id();
    void setRfId(utility::string_t value);
    /// <summary>
    ...
    void setCurrentLocationId(utility::string_t value);
    /// <summary>
    ...
    void setParentContainerId(utility::string_t value);
