...
void Pharmaceutical::fromJson(web::json::value& val)
{
    if(val.has_field(utility::conversions::to_string_t("pharmaceutical_id")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("pharmaceutical_id")];
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("gtin")];
        if(!fieldValue.is_null())
        {
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("trade_name")];
        if(!fieldValue.is_null())
        {
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("ean_code")];
        if(!fieldValue.is_null())
        {
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("manufacturer_id")];
        if(!fieldValue.is_null())
        {
...
void Pharmaceutical::setPharmaceuticalId(utility::string_t value)
{
...
void Pharmaceutical::setGtin(utility::string_t value)
{
    m_Gtin = value;
    m_GtinIsSet = true;
}
...
void Pharmaceutical::setTradeName(utility::string_t value)
{
    m_Trade_name = value;
...
void Pharmaceutical::setEanCode(utility::string_t value)
{
    m_Ean_code = value;
...
void Pharmaceutical::setManufacturerId(utility::string_t value)
{
...
void Pharmaceutical::setImage(utility::string_t value)
{
    m_Image = value;
    m_ImageIsSet = true;
}
