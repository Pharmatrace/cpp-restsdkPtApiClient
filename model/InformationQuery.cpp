...
void InformationQuery::validate()
{
    // TODO: implement validation
}

web::json::value InformationQuery::toJson() const
{
...
void InformationQuery::fromJson(const web::json::value& val)
{
...
void InformationQuery::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void InformationQuery::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
int64_t InformationQuery::getTimestamp() const
{
    return m_Timestamp;
}

void InformationQuery::setTimestamp(int64_t value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool InformationQuery::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void InformationQuery::unsetTimestamp()
{
    m_TimestampIsSet = false;
}

utility::string_t InformationQuery::getTxUid() const
{
    return m_Tx_uid;
}

void InformationQuery::setTxUid(const utility::string_t& value)
{
    m_Tx_uid = value;
    m_Tx_uidIsSet = true;
}

bool InformationQuery::txUidIsSet() const
{
    return m_Tx_uidIsSet;
}

void InformationQuery::unsetTx_uid()
{
    m_Tx_uidIsSet = false;
}

utility::string_t InformationQuery::getTermsId() const
{
    return m_Terms_id;
}

void InformationQuery::setTermsId(const utility::string_t& value)
{
    m_Terms_id = value;
    m_Terms_idIsSet = true;
}

bool InformationQuery::termsIdIsSet() const
{
    return m_Terms_idIsSet;
}

void InformationQuery::unsetTerms_id()
{
    m_Terms_idIsSet = false;
}

utility::string_t InformationQuery::getTransactionChannel() const
{
    return m_Transaction_channel;
}

void InformationQuery::setTransactionChannel(const utility::string_t& value)
{
    m_Transaction_channel = value;
    m_Transaction_channelIsSet = true;
}

bool InformationQuery::transactionChannelIsSet() const
{
    return m_Transaction_channelIsSet;
}

void InformationQuery::unsetTransaction_channel()
{
    m_Transaction_channelIsSet = false;
}
