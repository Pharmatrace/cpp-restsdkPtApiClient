...
#ifndef IO_PHARMATRACE_API_SCIN_PUBLIC_API_LocationsApi_H_
#define IO_PHARMATRACE_API_SCIN_PUBLIC_API_LocationsApi_H_
...
public:
    ...
    explicit LocationsApi( std::shared_ptr<ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<Location>> addLocation(
    ...
    pplx::task<std::shared_ptr<Location>> find_location_by_id(
        int64_t id
    );
...
#endif /* IO_PHARMATRACE_API_SCIN_PUBLIC_API_LocationsApi_H_ */
