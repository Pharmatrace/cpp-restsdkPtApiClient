...
#ifndef IO_PHARMATRACE_API_SCIN_PUBLIC_API_TradesApi_H_
#define IO_PHARMATRACE_API_SCIN_PUBLIC_API_TradesApi_H_
...
public:
    ...
    explicit TradesApi( std::shared_ptr<ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<Trade>> addTrade(
    ...
    pplx::task<std::vector<std::shared_ptr<Trade>>> findTrades(
    ...
    pplx::task<std::shared_ptr<Trade>> find_trade_by_id(
        int64_t id
    );
...
#endif /* IO_PHARMATRACE_API_SCIN_PUBLIC_API_TradesApi_H_ */
