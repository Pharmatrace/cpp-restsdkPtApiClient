...
#ifndef IO_PHARMATRACE_API_SCIN_PUBLIC_API_RepackagesApi_H_
#define IO_PHARMATRACE_API_SCIN_PUBLIC_API_RepackagesApi_H_
...
public:
    ...
    explicit RepackagesApi( std::shared_ptr<ApiClient> apiClient );

    virtual ~RepackagesApi();
    ...
    pplx::task<std::shared_ptr<Repackage>> addRepackage(
        std::shared_ptr<Repackage> repackage
    );
    /// <summary>
    /// 
    /// </summary>
    ...
    pplx::task<void> deleteRepackage(
        int64_t id
    );
    /// <summary>
    /// 
    ...
    pplx::task<std::vector<std::shared_ptr<Repackage>>> findRepackages(
    ...
    pplx::task<std::shared_ptr<Repackage>> find_repackage_by_id(
        int64_t id
    );
...
#endif /* IO_PHARMATRACE_API_SCIN_PUBLIC_API_RepackagesApi_H_ */
