...
#ifndef IO_PHARMATRACE_API_SCIN_PUBLIC_API_ContainersApi_H_
#define IO_PHARMATRACE_API_SCIN_PUBLIC_API_ContainersApi_H_
...
public:
    ...
    explicit ContainersApi( std::shared_ptr<ApiClient> apiClient );

    virtual ~ContainersApi();
    ...
    pplx::task<std::shared_ptr<Container>> addContainer(
    ...
    pplx::task<void> deleteContainer(
        int64_t id
    );
    /// <summary>
    /// 
    ...
    pplx::task<std::vector<std::shared_ptr<Container>>> findContainers(
    ...
    pplx::task<std::shared_ptr<Container>> find_container_by_id(
        int64_t id
    );
...
#endif /* IO_PHARMATRACE_API_SCIN_PUBLIC_API_ContainersApi_H_ */
