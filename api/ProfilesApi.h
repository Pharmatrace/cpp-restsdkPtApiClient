...
#ifndef IO_PHARMATRACE_API_SCIN_PUBLIC_API_ProfilesApi_H_
#define IO_PHARMATRACE_API_SCIN_PUBLIC_API_ProfilesApi_H_
...
public:
    ...
    explicit ProfilesApi( std::shared_ptr<ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<Profile>> addProfile(
    ...
    pplx::task<std::vector<std::shared_ptr<Profile>>> findProfiles(
    ...
    pplx::task<std::shared_ptr<Profile>> find_profile_by_id(
        int64_t id
    );
...
#endif /* IO_PHARMATRACE_API_SCIN_PUBLIC_API_ProfilesApi_H_ */
