...
#ifndef IO_PHARMATRACE_API_SCIN_PUBLIC_API_TransportsApi_H_
#define IO_PHARMATRACE_API_SCIN_PUBLIC_API_TransportsApi_H_
...
public:
    ...
    explicit TransportsApi( std::shared_ptr<ApiClient> apiClient );

    virtual ~TransportsApi();
    ...
    pplx::task<std::shared_ptr<Transport>> addTransport(
    ...
    pplx::task<void> deleteTransport(
        int64_t id
    );
    /// <summary>
    /// 
    ...
    pplx::task<std::vector<std::shared_ptr<Transport>>> findTransports(
    ...
    pplx::task<std::shared_ptr<Transport>> find_transport_by_id(
        int64_t id
    );
...
#endif /* IO_PHARMATRACE_API_SCIN_PUBLIC_API_TransportsApi_H_ */
