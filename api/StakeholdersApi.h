...
#ifndef IO_PHARMATRACE_API_SCIN_PUBLIC_API_StakeholdersApi_H_
#define IO_PHARMATRACE_API_SCIN_PUBLIC_API_StakeholdersApi_H_
...
public:
    ...
    explicit StakeholdersApi( std::shared_ptr<ApiClient> apiClient );

    virtual ~StakeholdersApi();
    ...
    pplx::task<std::shared_ptr<Stakeholder>> addStakeholder(
        std::shared_ptr<Stakeholder> stakeholder
    );
    /// <summary>
    /// 
    /// </summary>
    ...
    pplx::task<void> deleteStakeholder(
        int64_t id
    );
    /// <summary>
    /// 
    ...
    pplx::task<std::vector<std::shared_ptr<Stakeholder>>> findStakeholders(
    ...
    pplx::task<std::shared_ptr<Stakeholder>> find_stakeholder_by_id(
        int64_t id
    );
...
#endif /* IO_PHARMATRACE_API_SCIN_PUBLIC_API_StakeholdersApi_H_ */
