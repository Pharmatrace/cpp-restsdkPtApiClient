...
/*
 * SystemInformationsApi.h
 *
 * 
 */

#ifndef IO_PHARMATRACE_API_SCIN_PUBLIC_API_SystemInformationsApi_H_
#define IO_PHARMATRACE_API_SCIN_PUBLIC_API_SystemInformationsApi_H_
...
public:
    ...
    explicit SystemInformationsApi( std::shared_ptr<ApiClient> apiClient );

    virtual ~SystemInformationsApi();
    ...
    pplx::task<std::shared_ptr<SystemInformation>> addSystemInformation(
    ...
    pplx::task<void> deleteSystemInformation(
        int64_t id
    );
    /// <summary>
    /// 
    ...
    pplx::task<std::vector<std::shared_ptr<SystemInformation>>> findSystemInformations(
    ...
    pplx::task<std::shared_ptr<SystemInformation>> find_systeminformation_by_id(
        int64_t id
    );
...
#endif /* IO_PHARMATRACE_API_SCIN_PUBLIC_API_SystemInformationsApi_H_ */
